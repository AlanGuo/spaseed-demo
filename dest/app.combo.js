...
define("/spm_modules/spaseed/1.1.22/lib/dom", function(require, exports, module) {
    "use strict";
...
define("/spm_modules/spaseed/1.1.22/main/View", function(require, exports, module) {
    "use strict";
    var $ = require("spm_modules/spaseed/1.1.22/lib/dom"), Node = require("spm_modules/spaseed/1.1.22/main/Node");
...
define("/spm_modules/spaseed/1.1.22/main/Node", function(require, exports, module) {
    "use strict";
    var $ = require("spm_modules/spaseed/1.1.22/lib/dom"), mp = require("spm_modules/spaseed/1.1.22/main/mp");
...
define("/spm_modules/spaseed/1.1.22/main/mp", function(require, exports, module) {
    "use strict";
...
define("/spm_modules/spaseed/1.1.22/lib/Dialog", function(require, exports, module) {
    "use strict";
    /**
 * @dialog 模块
 * dialog.show(content,{
 ...
 * 目前只支持两个按钮
 */
    var Node = require("spm_modules/spaseed/1.1.22/main/Node"), Mask = require("spm_modules/spaseed/1.1.22/lib/Mask"), template = require("spm_modules/spaseed/1.1.22/lib/template");
...
define("/spm_modules/spaseed/1.1.22/lib/Mask", function(require, exports, module) {
    "use strict";
    var Node = require("spm_modules/spaseed/1.1.22/main/Node");
...
define("/spm_modules/spaseed/1.1.22/lib/template", function(require, exports, module) {
    "use strict";
    var template = require("tmp/app/view/view");
    var env = require("spm_modules/spaseed/1.1.22/lib/env");
...
define("/spm_modules/spaseed/1.1.22/lib/env", function(require, exports, module) {
    "use strict";
...
define("/spm_modules/spaseed/1.1.22/lib/ErrorTips", function(require, exports, module) {
    "use strict";
    var Node = require("spm_modules/spaseed/1.1.22/main/Node");
...
define("/spm_modules/spaseed/1.1.22/lib/Loading", function(require, exports, module) {
    "use strict";
    var Node = require("spm_modules/spaseed/1.1.22/main/Node"), template = require("spm_modules/spaseed/1.1.22/lib/template");
    var Mask = Node.extend({
        ctor: function(data) {
            data = data || {};
            data.className = "";
...
define("/spm_modules/spaseed/1.1.22/lib/asyncrequest", function(require, exports, module) {
    /**
 * promise
 * @class promise
 * @static
...
define("/spm_modules/spaseed/1.1.22/lib/binder", function(require, exports, module) {
    /**
 * @module binder
 * 绑定模块，提供双向绑定功能
 */
...
define("/app/script/module/page1/page1", function(require, exports, module) {
    "use strict";
    var $ = require("spm_modules/spaseed/1.1.22/lib/dom"), View = require("spm_modules/spaseed/1.1.22/main/View"), Dialog = require("spm_modules/spaseed/1.1.22/lib/Dialog"), ErrorTips = require("spm_modules/spaseed/1.1.22/lib/ErrorTips"), Loading = require("spm_modules/spaseed/1.1.22/lib/Loading"), template = require("spm_modules/spaseed/1.1.22/lib/template"), asyncRequest = require("spm_modules/spaseed/1.1.22/lib/asyncrequest"), binder = require("spm_modules/spaseed/1.1.22/lib/binder"), request = require("app/script/model/request");
...
define("/app/script/module/page2/page2", function(require, exports, module) {
    "use strict";
    var $ = require("spm_modules/spaseed/1.1.22/lib/dom");
    var template = require("spm_modules/spaseed/1.1.22/lib/template");
    var asyncRequest = require("spm_modules/spaseed/1.1.22/lib/asyncrequest");
    var request = require("app/script/model/request");
    var View = require("spm_modules/spaseed/1.1.22/main/View");
