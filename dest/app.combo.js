...
define("/app/script/module/page1/page1", function(require, exports, module) {
    var $ = require("spm_modules/spaseed/1.1.19/lib/dom"), View = require("spm_modules/spaseed/1.1.19/main/View"), Dialog = require("spm_modules/spaseed/1.1.19/lib/Dialog"), ErrorTips = require("spm_modules/spaseed/1.1.19/lib/ErrorTips"), Loading = require("spm_modules/spaseed/1.1.19/lib/Loading"), template = require("spm_modules/spaseed/1.1.19/lib/template"), asyncRequest = require("spm_modules/spaseed/1.1.19/lib/asyncrequest"), binder = require("spm_modules/spaseed/1.1.19/lib/binder"), request = require("app/script/model/request");
...
define("/app/script/module/page2/page2", function(require, exports, module) {
    var $ = require("spm_modules/spaseed/1.1.19/lib/dom");
    var template = require("spm_modules/spaseed/1.1.19/lib/template");
    var asyncRequest = require("spm_modules/spaseed/1.1.19/lib/asyncrequest");
    var request = require("app/script/model/request");
    var View = require("spm_modules/spaseed/1.1.19/main/View");
 ...
 * 目前只支持两个按钮
 */
define("/spm_modules/spaseed/1.1.19/lib/Dialog", function(require, exports, module) {
    var Node = require("spm_modules/spaseed/1.1.19/main/Node"), Mask = require("spm_modules/spaseed/1.1.19/lib/Mask"), template = require("spm_modules/spaseed/1.1.19/lib/template");
...
define("/spm_modules/spaseed/1.1.19/lib/ErrorTips", function(require, exports, module) {
    var Node = require("spm_modules/spaseed/1.1.19/main/Node");
...
define("/spm_modules/spaseed/1.1.19/lib/Loading", function(require, exports, module) {
    var Node = require("spm_modules/spaseed/1.1.19/main/Node"), template = require("spm_modules/spaseed/1.1.19/lib/template");
...
define("/spm_modules/spaseed/1.1.19/lib/Mask", function(require, exports, module) {
    var Node = require("spm_modules/spaseed/1.1.19/main/Node");
    var Mask = Node.extend({
        ctor: function(data) {
            data = data || {};
 ...
 * @static
 */
define("/spm_modules/spaseed/1.1.19/lib/asyncrequest", function(require, exports, module) {
    var asyncRequest = {
 ...
 * 绑定模块，提供双向绑定功能
 */
define("/spm_modules/spaseed/1.1.19/lib/binder", function(require, exports, module) {
...
define("/spm_modules/spaseed/1.1.19/lib/dom", function(require, exports, module) {
...
define("/spm_modules/spaseed/1.1.19/lib/env", function(require, exports, module) {
...
define("/spm_modules/spaseed/1.1.19/lib/template", function(require, exports, module) {
    var template = require("tmp/app/view/view");
    var env = require("spm_modules/spaseed/1.1.19/lib/env");
...
define("/spm_modules/spaseed/1.1.19/main/Node", function(require, exports, module) {
    var $ = require("spm_modules/spaseed/1.1.19/lib/dom"), mp = require("spm_modules/spaseed/1.1.19/main/mp");
...
define("/spm_modules/spaseed/1.1.19/main/View", function(require, exports, module) {
    var $ = require("spm_modules/spaseed/1.1.19/lib/dom"), Node = require("spm_modules/spaseed/1.1.19/main/Node");
...
define("/spm_modules/spaseed/1.1.19/main/mp", function(require, exports, module) {
